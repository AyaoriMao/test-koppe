...
from .forms import LoginForm, ReviewForm, SignUpForm
from .models import *
...
class SignUpMailSent(generic.TemplateView):
    """ユーザー仮登録したよ"""
    template_name = 'sign_up_mail_sent.html'
...
class SignUpDone(generic.TemplateView):
    ...
    def get(self, request, **kwargs):
        ...
        try:
            company_pk = loads(token, max_age=self.timeout_seconds)
        ...
        # tokenは問題なし
            ...
            try:
                user = User.objects.get(pk=company_pk)
